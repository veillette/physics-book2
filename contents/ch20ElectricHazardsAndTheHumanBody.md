...
resistance. For example, a person with dry skin has a resistance of about $$200 \text{k}\Omega $$ . If he comes into contact with 120-V AC, a current $$I=\left(120 \text{V}\right)/\left(200 \text{k}\Omega \right)= 0.6 \text{mA}$$ passes harmlessly through him. The same person soaking wet may have a resistance of $$10.0 \text{k}\Omega$$ and the same 120 V will produce a current of 12 mA—above
