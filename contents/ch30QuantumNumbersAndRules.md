...
values of quantized entities are expressed in terms of **quantum numbers**, and
the rules governing them are of the utmost importance in determining what nature
is and does. This section covers some of the more important quantum numbers and
rules—all of which apply in chemistry, material science, and far beyond the
...
to be the principal quantum number that labels the basic states of a system. The
lowest-energy state has $$n=1 $$ , the first excited state has $$n=2 $$ , and so
on. Thus the allowed values for the principal quantum number are

<div class="equation" >
 $$n=1, 2, 3, .... $$
</div>

This is more than just a numbering scheme, since the energy of the system, such
...
<div class="equation" >
 $$L=\sqrt{l\left(l+1\right)}\frac{h}{2\pi } \left(l=0, 1, 2, ..., n-1\right)\text{,} $$
</div>
...
ground-state angular momentum for hydrogen is actually zero, not $$h/2\pi $$ as
...
first excited state of hydrogen has $$n=2 $$ , so that $$l $$ can be either 0 or
1, according to the rule in $$L=\sqrt{l\left(l+1\right)}\frac{h}{2\pi } $$ .
Similarly, for $$n=3 $$ , $$l $$ can be 0, 1, or 2. It is often most convenient
to state the value of $$l $$ , a simple integer, rather than calculating the
value of $$L $$ from $$L=\sqrt{l\left(l+1\right)}\frac{h}{2\pi } $$ . For
example, for $$l=2 $$ , we see that

<div class="equation" >
 $$L=\sqrt{2\left(2+1\right)}\frac{h}{2\pi }=\sqrt{6}\frac{h}{2\pi }= 0.390h= 2.58 \times 10^{-34}  \text{J}\cdot s. $$
</div>
...
the five values –2, –1, 0, 1, and 2. Each $${m}_{l} $$ corresponds to a
different energy in the presence of a magnetic field, so that they are related
to the splitting of spectral lines into discrete parts, as discussed in the
preceding section. If the $$z $$ -component of angular momentum can have only
...
Calculate the angles that the angular momentum vector  $$\vb{L} $$
  can make with the  $$z $$
-axis for  $$l=1 $$ ,
 as illustrated in [[Figure 1]](#Figure1).

**Strategy**

[[Figure 1]](#Figure1) represents the vectors $$\vb{L} $$ and
$${\vb{L}}_{z} $$ as usual, with arrows proportional to their
magnitudes and pointing in the correct directions. $$\vb{L} $$ and
...
In summary:
- $$ l \ge 1 $$ (p, d, f, or higher orbitals)
- $$ n \ge 2 $$ (second shell or higher)
...
(a) For $$ l = 1 $$ :
<div class="equation">
$$ L = \sqrt{l(l+1)} \frac{h}{2\pi} = \sqrt{1(1+1)} \frac{h}{2\pi} = \sqrt{2} \frac{h}{2\pi} $$
</div>

<div class="equation">
$$ L = \sqrt{2} \times \frac{6.626 \times 10^{-34} \text{ J·s}}{2\pi} = \sqrt{2} \times 1.055 \times 10^{-34} \text{ J·s} $$
</div>

<div class="equation">
$$ L = 1.49 \times 10^{-34} \text{ J·s} $$
</div>

(b) Bohr's value for the $$ n = 1 $$ state:
<div class="equation">
$$ L_{\text{Bohr}} = n \frac{h}{2\pi} = 1 \times \frac{6.626 \times 10^{-34} \text{ J·s}}{2\pi} = 1.055 \times 10^{-34} \text{ J·s} $$
</div>

<div class="equation">
$$ L_{\text{Bohr}} = 1.06 \times 10^{-34} \text{ J·s} $$
</div>

Comparing the two values:
<div class="equation">
$$ \frac{L_{l=1}}{L_{\text{Bohr}, n=1}} = \frac{1.49 \times 10^{-34}}{1.06 \times 10^{-34}} = 1.41 = \sqrt{2} $$
</div>
...
<div class="equation">
$$ L = \sqrt{2} \frac{6.626 \times 10^{-34} \text{ J·s}}{2\pi} = \sqrt{2} (1.055 \times 10^{-34} \text{ J·s}) = 1.49 \times 10^{-34} \text{ J·s} $$
</div>

(b) For electron spin with $$ s = 1/2 $$ :

<div class="equation">
$$ S = \sqrt{s(s+1)} \frac{h}{2\pi} = \sqrt{\frac{1}{2}\left(\frac{1}{2}+1\right)} \frac{h}{2\pi} = \sqrt{\frac{1}{2} \cdot \frac{3}{2}} \frac{h}{2\pi} = \sqrt{\frac{3}{4}} \frac{h}{2\pi} $$
</div>

<div class="equation">
$$ S = \frac{\sqrt{3}}{2} \frac{h}{2\pi} = \frac{\sqrt{3}}{2} (1.055 \times 10^{-34} \text{ J·s}) = 9.13 \times 10^{-35} \text{ J·s} $$
</div>

(c) The ratio of orbital to spin angular momentum is:

<div class="equation">
$$ \frac{L}{S} = \frac{\sqrt{2} \frac{h}{2\pi}}{\frac{\sqrt{3}}{2} \frac{h}{2\pi}} = \frac{\sqrt{2}}{\frac{\sqrt{3}}{2}} = \frac{2\sqrt{2}}{\sqrt{3}} = \sqrt{\frac{4 \cdot 2}{3}} = \sqrt{\frac{8}{3}} = 1.63 $$
</div>
...
<div class="equation">
$$ L = \sqrt{12} \times \frac{6.626 \times 10^{-34} \text{ J·s}}{2\pi} = \sqrt{12} \times (1.055 \times 10^{-34} \text{ J·s}) $$
</div>

<div class="equation">
$$ L = 3.464 \times (1.055 \times 10^{-34} \text{ J·s}) = 3.66 \times 10^{-34} \text{ J·s} $$
</div>

(b) The electron spin angular momentum (same for all electrons regardless of $$ l $$ ):

<div class="equation">
$$ S = \sqrt{s(s+1)} \frac{h}{2\pi} = \sqrt{\frac{1}{2}\left(\frac{1}{2}+1\right)} \frac{h}{2\pi} = \sqrt{\frac{3}{4}} \frac{h}{2\pi} $$
</div>

<div class="equation">
$$ S = \frac{\sqrt{3}}{2} \times (1.055 \times 10^{-34} \text{ J·s}) = 9.13 \times 10^{-35} \text{ J·s} $$
</div>

(c) The ratio of orbital to spin angular momentum:

<div class="equation">
$$ \frac{L}{S} = \frac{\sqrt{12} \frac{h}{2\pi}}{\sqrt{3/4} \frac{h}{2\pi}} = \frac{\sqrt{12}}{\sqrt{3/4}} = \frac{\sqrt{12} \times 2}{\sqrt{3}} = \frac{2\sqrt{12}}{\sqrt{3}} = \frac{2 \times 2\sqrt{3}}{\sqrt{3}} = 4 $$
</div>
...
<div class="equation">
$$ L = \sqrt{l(l+1)} \frac{h}{2\pi} = \sqrt{2(2+1)} \frac{h}{2\pi} = \sqrt{6} \frac{h}{2\pi} $$
</div>

The $$ z $$ -component is:
<div class="equation">
$$ L_z = m_l \frac{h}{2\pi} = 2 \frac{h}{2\pi} $$
</div>

The angle is given by:
<div class="equation">
$$ \cos \theta = \frac{L_z}{L} = \frac{2 \frac{h}{2\pi}}{\sqrt{6} \frac{h}{2\pi}} = \frac{2}{\sqrt{6}} = \sqrt{\frac{4}{6}} = \sqrt{\frac{2}{3}} = 0.8165 $$
</div>

<div class="equation">
$$ \theta = \cos^{-1}(0.8165) = 35.3° $$
</div>
...
<div class="equation">
$$ S = \sqrt{s(s+1)} \frac{h}{2\pi} = \sqrt{\frac{1}{2}\left(\frac{1}{2}+1\right)} \frac{h}{2\pi} = \sqrt{\frac{3}{4}} \frac{h}{2\pi} = \frac{\sqrt{3}}{2} \frac{h}{2\pi} $$
</div>

The $$ z $$ -component can have two values:
<div class="equation">
$$ S_z = m_s \frac{h}{2\pi} = \pm \frac{1}{2} \frac{h}{2\pi} $$
</div>
