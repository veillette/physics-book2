...
![A two-person team in a bobsled race. The bobsled has an aerodynamic design and smooth runners so it can go as fast as possible.](../resources/Figure_05_02_01.jpg "From racing cars to bobsled racers, aerodynamic shaping is crucial to achieving top speeds. Bobsleds are designed for speed. They are shaped like a bullet with tapered fins. (credit: U.S. Army, via Wikimedia Commons) ")
{: #Figure1}
...
![A model plane is can be seen being tested in a wind tunnel.](../resources/Figure_05_02_02.jpg "NASA researchers test a model plane in a wind tunnel. (credit: NASA/Ames)")
{: #Figure2}
...
streamlined pattern (see [Figure 4](#Figure4)). In humans, one important example of
...
1. At terminal velocity, drag equals weight:
<div class="equation">
$$ F_{\text{D}} = mg $$
</div>
...
2. Calculate the ball bearing's properties:
   ...
   - Volume: $$ V = \frac{4}{3}\pi r^3 = \frac{4}{3}\pi(1.5 \times 10^{-3})^3 = 1.41 \times 10^{-8} \text{ m}^3 $$

3. Calculate the effective weight (including buoyancy):
<div class="equation">
...
4. At terminal velocity, Stokes drag equals effective weight:
<div class="equation">
$$ 6\pi r\eta v_t = W_{\text{eff}} $$
</div>
