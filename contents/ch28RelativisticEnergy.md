...
Conservation of energy is one of the most important laws in physics. Not only
...
3. Choose the appropriate equation. $${\text{KE}}_{\text{rel}}=\left(\gamma -1\right)mc^{2} $$ 4. Plug the knowns into the equation. First calculate $$\gamma $$ . We will
   carry extra digits because this is an intermediate calculation.
    ...
    <div class="equation" >
     $$\begin{array}{lll}\gamma & =& \frac{1}{\sqrt{1-\frac{ {v}^{2}}{ {c}^{2}}}}\\ & =& \frac{1}{\sqrt{1-\frac{ {\left(  0.990\text{c} \right)}^{2}}{ {c}^{2}}}}\\ & =& \frac{1}{\sqrt{1-{\left(  0.990 \right)}^{2}}}\\ & =&  7.0888\end{array} $$
    </div>
