...
where $$\lambda $$ is the wavelength of the emitted EM radiation and $$R $$ is
the **Rydberg constant**, determined by the experiment to be

<div class="equation" >
 $$R= 1.097 \times 10^{7} /\text{m} \left({\text{or m}}^{-1}\right). $$
</div>

The constant $${n}_{\text{f}} $$ is a positive integer associated with a
specific series. For the Lyman series, $${n}_{\text{f}}=1 $$ ; for the Balmer
series, $${n}_{\text{f}}=2 $$ ; for the Paschen series, $${n}_{\text{f}}=3 $$ ;
...
$${n}_{\text{f}} $$ increases. The constant $${n}_{\text{i}} $$ is a positive
integer, but it must be greater than $${n}_{\text{f}} $$ . Thus, for the Balmer
series, $${n}_{\text{f}}=2 $$ and $${n}_{\text{i}}=3, 4, 5, 6, ... $$ . Note
that $${n}_{\text{i}} $$ can approach infinity. While the formula in the
...
series by using different values of $${n}_{\text{f}} $$ . Bohr was the first to
comprehend the deeper meaning. Again, we see the interplay between experiment
and theory in physics. Experimentally, the spectra were well established, an
...
For an Integrated Concept problem, we must first identify the physical
...
analysis is valid for any single-electron atom. So, if a nucleus has $$Z $$
protons ( $$Z=1 $$ for hydrogen, 2 for helium, etc.) and only one electron, that
...
equation for $$v $$ , substitute it into the above, and rearrange the expression
to obtain the radius of the orbit. This yields:

<div class="equation" >
 $${r}_{n}=\frac{ {n}^{2}}{Z}{a}_{\text{B}}\text{, for allowed orbits}\left(n=1,2,3,\dots \right)\text{,} $$
</div>

where $${a}_{\text{B}} $$ is defined to be the **Bohr radius**, since for the
lowest orbit $$\left(n=1\right) $$ and for hydrogen $$\left(Z=1\right) $$ ,
$${r}_{1}={a}_{\text{B}} $$ . It is left for this chapter’s Problems and
...
orbital radius is proportional to $${n}^{2} $$ , as illustrated
in [[Figure 6]](#Figure6).

![The electron orbits are shown in the form of four concentric circles. The radius of each circle is marked as r sub one, r sub two, up to r sub four.](../resources/Figure_30_03_06.jpg "The allowed electron orbits in hydrogen have the radii shown. These radii were first calculated by Bohr and are given by the equation \( r_n=n^2/Z a_B \). The lowest orbit has the experimentally verified diameter of a hydrogen atom.")
{: #Figure6}
...
<div class="equation">
$$ \frac{1}{\lambda} = R \left( \frac{1}{n_{\text{f}}^2} - \frac{1}{n_i^2} \right) $$
</div>

With $$ n_{\text{f}} = 1 $$ and $$ n_i = 2 $$ :

<div class="equation">
$$ \frac{1}{\lambda} = \left(1.097 \times 10^7 \text{ m}^{-1}\right) \left( \frac{1}{1^2} - \frac{1}{2^2} \right) = \left(1.097 \times 10^7 \text{ m}^{-1}\right) \left( 1 - \frac{1}{4} \right) $$
</div>

<div class="equation">
$$ \frac{1}{\lambda} = \left(1.097 \times 10^7 \text{ m}^{-1}\right) \left( \frac{3}{4} \right) = 8.228 \times 10^6 \text{ m}^{-1} $$
</div>

<div class="equation">
$$ \lambda = \frac{1}{8.228 \times 10^6 \text{ m}^{-1}} = 1.22 \times 10^{-7} \text{ m} = 122 \text{ nm} $$
</div>
...
<div class="equation">
$$ \frac{1}{\lambda} = \left(1.097 \times 10^7 \text{ m}^{-1}\right) \left( \frac{1}{1^2} - \frac{1}{4^2} \right) $$
</div>

<div class="equation">
$$ \frac{1}{\lambda} = \left(1.097 \times 10^7 \text{ m}^{-1}\right) \left( 1 - \frac{1}{16} \right) = \left(1.097 \times 10^7 \text{ m}^{-1}\right) \left( \frac{15}{16} \right) $$
</div>

<div class="equation">
$$ \frac{1}{\lambda} = 1.028 \times 10^7 \text{ m}^{-1} $$
</div>

<div class="equation">
$$ \lambda = \frac{1}{1.028 \times 10^7 \text{ m}^{-1}} = 9.72 \times 10^{-8} \text{ m} = 97.2 \text{ nm} $$
</div>
...
<div class="equation">
$$ a_{\text{B}} = \frac{4.390 \times 10^{-67} \text{ J}^2\text{·s}^2}{(39.478)(9.109 \times 10^{-31})(8.988 \times 10^9)(2.566 \times 10^{-38})} \text{ kg·N·m}^2/\text{C}^2\text{·C}^2 $$
</div>

<div class="equation">
$$ a_{\text{B}} = \frac{4.390 \times 10^{-67}}{8.298 \times 10^{-57}} \text{ m} = 0.529 \times 10^{-10} \text{ m} = 5.29 \times 10^{-11} \text{ m} $$
</div>
...
<div class="equation">
$$ E_0 = \frac{2(9.870)(6.595 \times 10^{-76})(9.109 \times 10^{-31})(8.079 \times 10^{19})}{4.390 \times 10^{-67}} $$
</div>

<div class="equation">
$$ E_0 = \frac{9.521 \times 10^{-86}}{4.390 \times 10^{-67}} = 2.169 \times 10^{-18} \text{ J} $$
</div>

Converting to electron volts (dividing by $$ q_e = 1.602 \times 10^{-19} \text{ J/eV} $$ ):

<div class="equation">
$$ E_0 = \frac{2.169 \times 10^{-18} \text{ J}}{1.602 \times 10^{-19} \text{ J/eV}} = 13.6 \text{ eV} $$
</div>
...
<div class="equation">
$$ \frac{13.6 \text{ eV}}{n^2} = 0.850 \text{ eV} $$
</div>

Solving for $$ n^2 $$ :

<div class="equation">
$$ n^2 = \frac{13.6 \text{ eV}}{0.850 \text{ eV}} = 16.0 $$
</div>
...
<div class="equation">
$$ r_2 = (2)^2 a_{\text{B}} = 4 \times (0.529 \times 10^{-10} \text{ m}) = 2.12 \times 10^{-10} \text{ m} $$
</div>
...
<div class="equation">
$$ \frac{13.6 \text{ eV}}{hc} = \frac{13.6 \text{ eV}}{1240 \text{ eV·nm}} $$
</div>

<div class="equation">
$$ = \frac{13.6}{1240} \text{ nm}^{-1} = 0.01097 \text{ nm}^{-1} $$
</div>
...
<div class="equation">
$$ \frac{1}{\lambda_{\text{min}}} = R \left( \frac{1}{2^2} - 0 \right) = \frac{R}{4} = \frac{1.097 \times 10^7 \text{ m}^{-1}}{4} = 2.743 \times 10^6 \text{ m}^{-1} $$
</div>

<div class="equation">
$$ \lambda_{\text{min}} = \frac{1}{2.743 \times 10^6 \text{ m}^{-1}} = 3.65 \times 10^{-7} \text{ m} = 365 \text{ nm} $$
</div>
...
<div class="equation">
$$ \frac{1}{\lambda_{\text{min}}} = \frac{1.097 \times 10^7 \text{ m}^{-1}}{9} = 1.219 \times 10^6 \text{ m}^{-1} $$
</div>

<div class="equation">
$$ \lambda_{\text{min}} = \frac{1}{1.219 \times 10^6 \text{ m}^{-1}} = 8.20 \times 10^{-7} \text{ m} = 820 \text{ nm} $$
</div>
...
<div class="equation">
$$ \frac{1}{\lambda_{\text{B,min}}} = R \left( \frac{1}{2^2} - 0 \right) = \frac{R}{4} $$
</div>

<div class="equation">
$$ \lambda_{\text{B,min}} = \frac{4}{R} = \frac{4}{1.097 \times 10^7 \text{ m}^{-1}} = 365 \text{ nm} $$
</div>

**Longest Lyman wavelength** (first line, $$ n_f = 1 $$, $$ n_i = 2 $$ ):

<div class="equation">
$$ \frac{1}{\lambda_{\text{L,max}}} = R \left( \frac{1}{1^2} - \frac{1}{2^2} \right) = R \left( \frac{3}{4} \right) $$
</div>

<div class="equation">
$$ \lambda_{\text{L,max}} = \frac{4}{3R} = \frac{4}{3 \times 1.097 \times 10^7 \text{ m}^{-1}} = 122 \text{ nm} $$
</div>
...
<div class="equation">
$$ \lambda = 4.653 \text{ μm} = 4.653 \times 10^{-6} \text{ m} $$
</div>
...
<div class="equation">
$$ \frac{1}{4.653 \times 10^{-6}} = (1.097 \times 10^7) \left( \frac{1}{25} - \frac{1}{n_i^2} \right) $$
</div>

<div class="equation">
$$ 2.149 \times 10^5 = (1.097 \times 10^7) \left( \frac{1}{25} - \frac{1}{n_i^2} \right) $$
</div>

<div class="equation">
$$ \frac{2.149 \times 10^5}{1.097 \times 10^7} = \frac{1}{25} - \frac{1}{n_i^2} $$
</div>

<div class="equation">
$$ 0.0196 = 0.0400 - \frac{1}{n_i^2} $$
</div>

<div class="equation">
$$ \frac{1}{n_i^2} = 0.0400 - 0.0196 = 0.0204 $$
</div>

<div class="equation">
$$ n_i^2 = \frac{1}{0.0204} = 49.0 $$
</div>
...
<div class="equation">
$$ r_1 = \frac{1^2}{2} a_{\text{B}} = \frac{a_{\text{B}}}{2} = 0.5 \, a_{\text{B}} $$
</div>

Therefore, the radius of $$\text{He}^+$$ in its ground state is **half the Bohr radius** of hydrogen, or:

<div class="equation">
$$ r_1 = 0.5 \times (0.529 \times 10^{-10} \text{ m}) = 0.265 \times 10^{-10} \text{ m} = 0.265 \text{ Å} $$
</div>
...
<div class="equation">
$$ r_n = \frac{n^2}{Z} a_{\text{B}} = \frac{n^2}{4} a_{\text{B}} $$
</div>

Setting this equal to $$ a_{\text{B}} $$ :

<div class="equation">
$$ \frac{n^2}{4} a_{\text{B}} = a_{\text{B}} $$
</div>
...
<div class="equation">
$$ E_2 = -\frac{Z^2}{n^2}(13.6 \text{ eV}) = -\frac{(4)^2}{(2)^2}(13.6 \text{ eV}) = -\frac{16}{4}(13.6 \text{ eV}) = -4 \times 13.6 \text{ eV} $$
</div>
...
<div class="equation">
$$ \Delta E = E_4 - E_3 = -\frac{Z^2 E_0}{n_i^2} - \left( -\frac{Z^2 E_0}{n_f^2} \right) = Z^2 E_0 \left( \frac{1}{n_f^2} - \frac{1}{n_i^2} \right) $$
</div>

<div class="equation">
$$ \Delta E = (36)(13.6 \text{ eV}) \left( \frac{1}{3^2} - \frac{1}{4^2} \right) = (489.6 \text{ eV}) \left( \frac{1}{9} - \frac{1}{16} \right) $$
</div>

<div class="equation">
$$ \Delta E = (489.6 \text{ eV}) \left( \frac{16 - 9}{144} \right) = (489.6 \text{ eV}) \left( \frac{7}{144} \right) = 23.8 \text{ eV} $$
</div>

Converting to wavelength using $$ \lambda = \frac{hc}{\Delta E} $$ and $$ hc = 1240 \text{ eV·nm} $$ :

<div class="equation">
$$ \lambda = \frac{1240 \text{ eV·nm}}{23.8 \text{ eV}} = 52.1 \text{ nm} $$
</div>
...
<div class="equation">
$$ \text{Average} = \frac{0.024\% + 0.023\% + 0.041\% + 0.030\%}{4} = \frac{0.118\%}{4} = 0.030\% $$
</div>
