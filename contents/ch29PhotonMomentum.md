...
To check the validity of this relation, note that $$E=hc/\lambda $$ for a
...
<div class="equation" >
 $$\frac{E}{P}=\frac{ \gamma m{c}^{2}}{ \gamma mu}=\frac{ {\text{c}}^{2}}{u}. $$
</div>
