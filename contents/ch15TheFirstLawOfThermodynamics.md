...
applies the conservation of energy principle to systems where heat transfer and
...
heat transfer into the system; if $$W $$ is positive, then there is net work
done by the system. So positive $$Q $$ adds energy to the system and positive
